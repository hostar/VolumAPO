...
wstring RegistryHelper::toUpperCase(wstring& s)
{
...
wstring RegistryHelper::readValue(wstring key, wstring valuename)
{
	...
	if (status != ERROR_SUCCESS)
	{
		...
		throw RegistryException(L"Error while reading registry value " + key + L"\\" + valuename + L": " + RegistryHelper::getSystemErrorString(status));
	}
...
void RegistryHelper::writeValue(wstring key, wstring valuename, wstring value)
{
	...
	if (status != ERROR_SUCCESS)
		throw RegistryException(L"Error while writing to registry value " + key + L"\\" + valuename + L": " + RegistryHelper::getSystemErrorString(status));
}
...
void RegistryHelper::deleteValue(wstring key, wstring valuename)
{
	...
	if (status != ERROR_SUCCESS)
		throw RegistryException(L"Error while deleting registry value " + key + L"\\" + valuename + L": " + RegistryHelper::getSystemErrorString(status));
}
...
void RegistryHelper::createKey(wstring key)
{
	...
	if (status != ERROR_SUCCESS)
		throw RegistryException(L"Error while creating registry key " + key + L": " + RegistryHelper::getSystemErrorString(status));
...
void RegistryHelper::deleteKey(wstring key)
{
	...
	if (status != ERROR_SUCCESS)
		throw RegistryException(L"Error while deleting registry key " + key + L": " + RegistryHelper::getSystemErrorString(status));
}
...
void RegistryHelper::makeWritable(wstring key)
{
	...
	if (status != ERROR_SUCCESS)
		throw RegistryException(L"Error while getting security information for registry key " + key + L": " + RegistryHelper::getSystemErrorString(status));
	...
	if (status != ERROR_SUCCESS)
		throw RegistryException(L"Error while setting security information for registry key " + key + L": " + RegistryHelper::getSystemErrorString(status));
...
vector<wstring> RegistryHelper::enumSubKeys(wstring key)
{
	...
	if (status != ERROR_NO_MORE_ITEMS)
		throw RegistryException(L"Error while enumerating sub keys of registry key " + key + L": " + RegistryHelper::getSystemErrorString(status));
...
bool RegistryHelper::keyEmpty(wstring key)
{
	...
	if (status != ERROR_SUCCESS)
		throw RegistryException(L"Error while reading info for registry key " + key + L": " + RegistryHelper::getSystemErrorString(status));
...
HKEY RegistryHelper::openKey(const wstring& key, REGSAM samDesired)
{
	...
	if (status != ERROR_SUCCESS)
		throw RegistryException(L"Error while opening registry key " + key + L": " + RegistryHelper::getSystemErrorString(status));
...
wstring RegistryHelper::splitKey(const wstring& key, HKEY* rootKey)
{
	...
	wstring p = RegistryHelper::toUpperCase(rootPart);
