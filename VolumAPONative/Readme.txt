...
3. Stop the Windows Audio service (AudioSrv) to unlock the MinimalAPO.dll. (net stop audiosrv)
4. Build the Visual Studio project to overwrite it with the new DLL.
5. Start the Windows Audio service again and continue with step 1. (net start audiosrv)
