...
namespace VolumAPO.Internals
{
    public class MouseHook : IDisposable
    {
        ...
        private static MouseHook? mouseHookInstance;
        public static void StartMouseHook()
        {
            mouseHookInstance = new();

            mouseHookInstance.MouseWheelUp += _ => GlobalHelpers.SetVolumeUp();
            mouseHookInstance.MouseWheelDown += _ => GlobalHelpers.SetVolumeDown();

            //mouseHookInstance.MouseWheelUp += _ => GlobalHelpers.SetVolumeUp();
            //mouseHookInstance.MouseWheelDown += _ => GlobalHelpers.SetVolumeDown();

            mouseHookInstance.Initialize(() => CursorInfo1.IsOnTaskbar());
            /*
